...
aspire = pd.read_csv('/content/MPESA_TRNS_2025-06-16.csv')
safaricom = pd.read_csv('/content/Mpesa_852182_20250616235959.csv')
...
filename = '/content/Mpesa_852182_20250616235959.csv'
